...
\cvline
  {Интересы}{Бэкенд, фронтенд, telegram-боты, Linux}
\cvline
  {Языки}{Python, JavaScript, SQL, C++, Kotlin, Haskell}
\cvline
  {Фреймфорки, библиотеки}{Django, NumPy, Pandas, jQuery, SortableJS, FastAPI, PostgreSQL}
