...
\cvline
  {Интересы}{Бэкенд, фронтенд, Linux}
\cvline
  {Языки}{Python, JavaScript, C++, Kotlin, Haskell}
\cvline
  {Фреймфорки, библиотеки}{Django, NumPy, Pandas, jQuery, SortableJS}
...
\cvlistitem{Python, Django, JS, jQuery, SortableJS, Bootstrap, PostgreSQL}
...
\cventry{Янв 2018--\\Июль 2020}{Mister X}{учебная практика}{ФМЛ 239 и СПбГУ МКН}{\newline{}\url{https://gitlab.com/tamarinvs19/misterX}}{}
\cvlistitem {
Реализация настольной игры <<Мистер Х>> для 2-5 игроков в формате веб-сайта \\\url{https://misterx.herokuapp.com}. 
}
\cvlistitem{Разработал интерфейс, имитирующий реальную игру}
\cvlistitem{Написал серверную часть, контролирующую игру}
\cvlistitem{Развернул на Heroku}
\cvlistitem{Python, Django, JS, jQuery, VueJS}
